...
g++ -shared -o ..\..\compiledLib\mingw\videoinput_dll.dll ..\libs\videoInput-c-api\src\video_input.o ..\libs\videoInput\videoInput.o %LIBS% -Wl,--out-implib,..\..\compiledLib\mingw\libvideoinput_dll.a
@echo off
if %errorlevel% neq 0 goto error
